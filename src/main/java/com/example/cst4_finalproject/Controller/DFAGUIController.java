...
import com.example.cst4_finalproject.Logic.DFAVisualizer;
import com.example.cst4_finalproject.Model.Automaton;
...
public class DFAGUIController {
    ...
    private com.example.cst4_finalproject.Logic.DFAVisualizer DFAVisualizer;
    ...
    public void gotoHome  (ActionEvent event ) throws IOException {
        ...
        if (event.getSource() == exitButton) {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/Options.fxml"));
