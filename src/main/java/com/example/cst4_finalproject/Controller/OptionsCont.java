...
public class OptionsCont implements Initializable {
    ...
    public void gotoCFG (ActionEvent event ) throws IOException {
        if (event.getSource() == simulatecfg) {
            ...
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/CFGSimulator.fxml"));
    ...
    public void gotoDFA  (ActionEvent event ) throws IOException {
        if (event.getSource() == simulatedfa) {
            ...
            Stage stage = new Stage();
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/DFASimulator.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            stage.setScene(scene);
            stage.show();
        }
    ...
    public void gotoNDFA  (ActionEvent event ) throws IOException {
        if (event.getSource() == simulatendfa) {
            ...
            Stage stage = new Stage();
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/NDFASimulator.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            stage.setScene(scene);
            stage.show();
        }
    ...
    public void gotoPDA  (ActionEvent event ) throws IOException {
        if (event.getSource() == simulatePDA) {
            ...
            Stage stage = new Stage();
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/PDA.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            stage.setScene(scene);
            stage.show();
        }
    ...
    public void gotoTM  (ActionEvent event ) throws IOException {
        ...
        if (event.getSource() == simulatetm) {
            ...
            Stage stage = new Stage();
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/Operation.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            stage.setScene(scene);
            stage.show();
        }
    ...
    public void gotoTH (ActionEvent event ) throws IOException {
        if (event.getSource() == simulateth) {
            ...
            Stage stage = new Stage();
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("/com/example/cst4_finalproject/TowerofHanoi.fxml"));
            Scene scene = new Scene(fxmlLoader.load());
            stage.setScene(scene);
            stage.show();
        }
